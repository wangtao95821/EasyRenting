//
//  RentingPageCellTableViewCell.m
//  EasyRenting
//
...
#import "Define.h"
@implementation RentingPageCellTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.cellFinishBtn = [[UIButton alloc]init];
        [self.contentView addSubview:self.cellFinishBtn];
        
//        self.cellEWMImage = [[UIImageView alloc]init];
//        [self.contentView addSubview:self.cellEWMImage];
...
- (void)layoutSubviews{
    ...
    self.cellLineLabel.frame = CGRectMake(WIDTH5S(15), HEIGHT5S(120+40)-1, WIDTH5S(305), 1);
    
    self.cellLineLabel.backgroundColor = COLOR(223, 223, 223, 1);
    
    
    self.cellFinishBtn.frame = CGRectMake(WIDTH5S(230), HEIGHT5S(125), WIDTH5S(70), HEIGHT5S(18));
    
    self.cellFinishBtn.titleLabel.font = FONT(13);
    
    [self.cellFinishBtn setTitle:@"完成出租" forState:UIControlStateNormal];
    
    [self.cellFinishBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    
    self.cellFinishBtn.backgroundColor = COLOR(243, 197, 1, 1);
    
    self.cellFinishBtn.layer.cornerRadius = 5;
    
//    self.cellEWMImage.frame = CGRectMake(WIDTH5S(132), HEIGHT5S(115), WIDTH5S(30), WIDTH5S(30));
//    
//    self.cellEWMImage.backgroundColor = [UIColor purpleColor];
}
